...
\begin{example}
    ...
    is separable but it is actually impossible to solve explicitly for the solution $y(t)$
    algebraically (\ldots don't just trust me, do the separation \ldots).  Let's see what
    MATLAB can do.
\begin{lstlisting}
