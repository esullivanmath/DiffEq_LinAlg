...
\section{Gaussian Elimination: Reduced Row Eschelon Form}
...
\begin{challenge}
    ...
    measured 1m
    by 1m (broken into 10cm by 10cm squares).  Extend the idea from the previous problem to find the temperature at each of
