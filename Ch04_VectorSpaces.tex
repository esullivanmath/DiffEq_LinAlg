...
matrices and let's motivate a few questions about matrices via a traffic flow problem.
...
\begin{problem}
    ...
    cars that flow into the network need to flow out.
    \begin{center}
        \begin{tikzpicture}
            \draw[thick, ->] (0,0) node[anchor=east]{800} -- (0.5,0);
            \draw[thick] (0.5,0) -- (1,0);
            \draw[thick] (1,0) -- (10,0);
            \draw[thick,->] (1,-1) node[anchor=north]{$700$}-- (1,-0.5);
            \draw[thick] (1,-0.5) -- (1,0);
            \draw[thick] (1,0) -- (4,0) -- (8,0) -- (8,2) -- (4,2) -- (1,0) -- (4,0) --
            (4,2);
            \draw[fill=black] (1,0) node[anchor=north west]{$A$} circle(0.05cm);
            \draw[fill=black] (4,0) node[anchor=north west]{$B$} circle(0.05cm);
            \draw[fill=black] (8,0) node[anchor=north west]{$C$} circle(0.05cm);
            \draw[fill=black] (8,2) node[anchor=north west]{$D$} circle(0.05cm);
